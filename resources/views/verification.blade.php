...
@section('content')
    <div class="progress-bar" role="progressbar" aria-valuenow="2" aria-valuemin="1" aria-valuemax="3"><span class="complete">Provide Info</span><span class="active">Verify Info</span><span>Confirmation</span></div>
    <h1>Verification</h1>
